...
<script>
    ...
    // Call setupDatePickers when opening reservation modal
    function openReservationModal(propertyId, propertyName, propertyPrice) {
        // Existing modal setup code...
        setupDatePickers(propertyId);

        // Rest of your existing openReservationModal code...
    }

    // Attach openReservationModal to global scope if it's not already there
